...
function isFile (pathFile) {
  assert.strictEqual(typeof pathFile, 'string', 'enoki: arg1 pathFile must be type string')
  return path.extname(pathFile) !== ''
}

function getFileMeta (opts) {
  assert.strictEqual(typeof opts, 'object', 'enoki: arg1 opts must be type object')
  assert.strictEqual(typeof opts.pathFile, 'string', 'enoki: arg1 opts.pathFile must be type string')
  assert.strictEqual(typeof opts.pathParent, 'string', 'enoki: arg1 opts.pathParent must be type string')
  assert.strictEqual(typeof opts.pathRoot, 'string', 'enoki: arg1 opts.pathRoot must be type string')
  assert.strictEqual(typeof opts.filetypes, 'object', 'enoki: arg1 opts.filetypes must be type string')
